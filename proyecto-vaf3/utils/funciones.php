...
function buscar($conn, $termino_busqueda)
{
    ...
    $sqlPersonajes = "SELECT id_personaje as id, nombre, descripcion, imagen_principal as imagen, 'personajes' as tabla FROM personajes WHERE LOWER(nombre) LIKE '%$termino_busqueda%'";
    ...
    // consultas vehiculos
    $sqlVehiculos = "SELECT id_vehiculo as id, nombre, descripcion, imagen_principal as imagen, 'vehiculos' as tabla FROM vehiculos WHERE LOWER(nombre) LIKE '%$termino_busqueda%'";
    ...
    // consultas peliculas
    $sqlPeliculas = "SELECT id_pelicula as id, titulo as nombre, resumen as descripcion, imagen_principal as imagen, 'peliculas' as tabla FROM peliculas WHERE LOWER(titulo) LIKE '%$termino_busqueda%'";
    ...
    $sqlLineaTiempo = "SELECT id_evento as id, año as nombre, historia as descripcion, imagen_principal as imagen, 'linea_tiempo' as tabla FROM linea_tiempo WHERE LOWER(historia) LIKE '%$termino_busqueda%'";
